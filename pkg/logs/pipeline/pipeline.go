...
func NewPipeline(chanSize int, connManager *sender.ConnectionManager, outputChan chan message.Message) *Pipeline {
	// initialize the sender
	senderChan := make(chan message.Message, chanSize)
